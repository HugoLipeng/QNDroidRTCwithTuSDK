package com.qiniu.droid.rtc.demo.tusdk;
    ...
    public void onBindViewHolder(final StickerHolder holder, final int position)
    {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    mOnItemClickListener.onClickItem(finalModel,holder,position);
                }
            }
        });
...
//            holder.lsq_item_image.setImageBitmap(ImageLoaderHelper.loadDiscBitmap(model.getPreviewNamePath()));
